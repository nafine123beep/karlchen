 ...
 *
 * Teaches: Trump hierarchy, Farbzwang, trumping when void, highest card wins.
 *
 * 48 cards total (4 suits x 6 ranks x 2 copies):
 * - 24 trump cards (8 Queens + 8 Jacks + 8 Diamond non-face)
 * - 24 non-trump cards (Clubs/Spades/Hearts: A, 10, K, 9 x 2 copies)
 *
 * Human (P0) is Team Re with strong trump hand.
...
export const HAND_PLAYER_0: CardDef[] = [
  { suit: Suit.CLUBS, rank: Rank.QUEEN, copyNumber: 1 },     // trump order 0 (highest!)
  { suit: Suit.SPADES, rank: Rank.QUEEN, copyNumber: 1 },    // trump order 1
  { suit: Suit.HEARTS, rank: Rank.QUEEN, copyNumber: 1 },    // trump order 2
  { suit: Suit.CLUBS, rank: Rank.JACK, copyNumber: 1 },      // trump order 4
  { suit: Suit.SPADES, rank: Rank.JACK, copyNumber: 1 },     // trump order 5
  { suit: Suit.DIAMONDS, rank: Rank.ACE, copyNumber: 1 },    // trump order 8 (Fox)
  { suit: Suit.DIAMONDS, rank: Rank.TEN, copyNumber: 1 },    // trump order 9
  { suit: Suit.DIAMONDS, rank: Rank.KING, copyNumber: 1 },   // trump order 10
...
/** Player 1 (AI, Kontra): 5 trumps, 7 non-trumps */
export const HAND_PLAYER_1: CardDef[] = [
  { suit: Suit.DIAMONDS, rank: Rank.QUEEN, copyNumber: 1 },  // trump order 3
  { suit: Suit.HEARTS, rank: Rank.JACK, copyNumber: 1 },     // trump order 6
  { suit: Suit.DIAMONDS, rank: Rank.JACK, copyNumber: 1 },   // trump order 7
  { suit: Suit.DIAMONDS, rank: Rank.NINE, copyNumber: 1 },   // trump order 11
  { suit: Suit.DIAMONDS, rank: Rank.ACE, copyNumber: 2 },    // trump order 8
...
export const HAND_PLAYER_2: CardDef[] = [
  { suit: Suit.CLUBS, rank: Rank.QUEEN, copyNumber: 2 },     // trump order 0
  { suit: Suit.DIAMONDS, rank: Rank.QUEEN, copyNumber: 2 },  // trump order 3
  { suit: Suit.DIAMONDS, rank: Rank.TEN, copyNumber: 2 },    // trump order 9
  { suit: Suit.DIAMONDS, rank: Rank.KING, copyNumber: 2 },   // trump order 10
  { suit: Suit.DIAMONDS, rank: Rank.NINE, copyNumber: 2 },   // trump order 11
...
/** Player 3 (AI, Kontra): 6 trumps, 6 non-trumps */
export const HAND_PLAYER_3: CardDef[] = [
  { suit: Suit.SPADES, rank: Rank.QUEEN, copyNumber: 2 },    // trump order 1
  { suit: Suit.HEARTS, rank: Rank.QUEEN, copyNumber: 2 },    // trump order 2
  { suit: Suit.CLUBS, rank: Rank.JACK, copyNumber: 2 },      // trump order 4
  { suit: Suit.SPADES, rank: Rank.JACK, copyNumber: 2 },     // trump order 5
  { suit: Suit.HEARTS, rank: Rank.JACK, copyNumber: 2 },     // trump order 6
  { suit: Suit.DIAMONDS, rank: Rank.JACK, copyNumber: 2 },   // trump order 7
  ...
  { suit: Suit.HEARTS, rank: Rank.TEN, copyNumber: 1 },      // non-trump
  { suit: Suit.HEARTS, rank: Rank.TEN, copyNumber: 2 },      // non-trump
 ...
 *
 * Expected trick flow:
 *  0: P0 leads CQ1 → P0 wins (teach: highest trump)
 ...
 * 10: P3 leads HT1, P0 trumps → P0 wins (teach: trumping to win)
 * 11: P0 leads DT1, P1 plays DQ1 → P1 wins (teach: Queen beats Diamond)
 *
 * Re team (P0+P2) wins 153-87.
 */
export const ILLUSION_AI_MOVES: Record<string, string>[] = [
  // Trick 0: P0 leads (human plays CQ1 ideally)
  {
  ...
  {
    player_1: cardId(Suit.HEARTS, Rank.NINE, 1),
