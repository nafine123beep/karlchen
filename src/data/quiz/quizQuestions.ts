...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    explanation:
      'Bei einer Fehlfarbe gilt Farbzwang \u2013 du musst die Farbe bedienen, wenn du kannst.',
  },
  {
    ...
    explanation:
      'Wenn kein Trumpf gespielt wird, gewinnt die h\u00f6chste Karte der angespielten Farbe.',
  },
  {
    id: 'Q_TRUMPFZWANG',
    questionText:
      'Karo 10 (Trumpf) wird ausgespielt. Du hast noch Trumpf auf der Hand. Was musst du tun?',
    options: [
      'Trumpf spielen',
    ...
    correctOptionIndex: 0,
    explanation:
      'Wird Trumpf ausgespielt, gilt Trumpfzwang. Du musst Trumpf spielen, wenn du welchen hast.',
  },
  {
    ...
    correctOptionIndex: 1,
    explanation:
      'Sind mehrere Tr\u00fcmpfe im Stich, gewinnt der h\u00f6here Trumpf gem\u00e4\u00df der Trumpfreihenfolge.',
  },
  {
  ...
  },
  {
    ...
    questionText:
      'Kreuz wird ausgespielt. Du hast kein Kreuz und keinen Trumpf. Was darfst du spielen?',
    options: ['Eine beliebige Karte', 'Du musst passen', 'Nur eine hohe Karte'],
    correctOptionIndex: 0,
    explanation:
      'Wenn du weder die Farbe bedienen noch Trumpf spielen kannst, darfst du eine beliebige Karte spielen.',
  },
  {
    id: 'Q_TRUMP_OVERRIDES',
    questionText:
      'Herz wird ausgespielt. Spieler 3 spielt Trumpf. Was bedeutet das f\u00fcr den Stich?',
    options: [
  ...
  },
  {
    ...
    options: ['Karo 9', 'Herz K\u00f6nig', 'Pik Dame'],
    correctOptionIndex: 1,
    explanation:
      'Karo ist Trumpf und Damen sind immer Trumpf. Herz K\u00f6nig ist eine normale Fehlkarte.',
  },
  {
    id: 'Q_MUST_FOLLOW_LOW',
    questionText: 'Pik Ass wird ausgespielt. Du hast nur Pik 9. Was musst du tun?',
    options: ['Trumpf spielen', 'Pik 9 spielen', 'Eine andere Fehlfarbe spielen'],
    correctOptionIndex: 1,
